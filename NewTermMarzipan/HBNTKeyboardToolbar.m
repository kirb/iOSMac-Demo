...
- (instancetype)init {
	...
	if (self) {
		...
		for (UIView *view in @[ _ctrlKey, _metaKey, _tabKey, spacerView, _upKey, _downKey, _leftKey, _rightKey ]) {
			...
			[self addConstraintsWithVisualFormat:@"V:|-margin-[key]-margin-|" options:kNilOptions metrics:@{
		...
		[self addConstraintsWithVisualFormat:@"H:|-outerMargin-[ctrlKey]-margin-[metaKey]-margin-[tabKey][spacerView(>=margin)][_upKey]-margin-[_downKey]-margin-[_leftKey]-margin-[_rightKey]-outerMargin-|" options:kNilOptions metrics:@{
			@"outerMargin": @3.f,
			@"margin": @6.f
		} views:@{
			@"ctrlKey": _ctrlKey,
